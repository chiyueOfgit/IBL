...
//    // --------------------
//    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "PBR_LIGHT_TEXTURED", NULL, NULL);
...
//    // -------------------------
//    Shader shader("1.2.lighting_textured/1.2.pbr.vert", "1.2.lighting_textured/1.2.pbr.frag");
//
//    shader.use();
