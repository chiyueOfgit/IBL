...
//    // -------------------------
//    Shader pbrShader("2.2.2.ibl_specular_textured/2.2.2.pbr.vert", "2.2.2.ibl_specular_textured/2.2.2.pbr.frag");
//    Shader equirectangularToCubemapShader("2.2.2.ibl_specular_textured/2.2.2.cubemap.vert", "2.2.2.ibl_specular_textured/2.2.2.equirectangular_to_cubemap.frag");
//    Shader irradianceShader("2.2.2.ibl_specular_textured/2.2.2.cubemap.vert", "2.2.2.ibl_specular_textured/2.2.2.irradiance_convolution.frag");
//    Shader prefilterShader("2.2.2.ibl_specular_textured/2.2.2.cubemap.vert", "2.2.2.ibl_specular_textured/2.2.2.prefilter.frag");
//    Shader brdfShader("2.2.2.ibl_specular_textured/2.2.2.brdf.vert", "2.2.2.ibl_specular_textured/2.2.2.brdf.frag");
//    Shader backgroundShader("2.2.2.ibl_specular_textured/2.2.2.background.vert", "2.2.2.ibl_specular_textured/2.2.2.background.frag");
//
//    pbrShader.use();
